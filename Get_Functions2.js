...
function Get_CP() {
	...
	var x = '[{"name":"Bulbasaur","Stats":[118,118,90],"Evolutions":["ivysaur","venusaur"]},{"name":"Bulbasaur2","Stats":[1182,118,90],"Evolutions":["ivysaur","venusaur"]}]';
$.get( "List_Pokemon2.json", function( data ) {
    x = data;
});
...
fr.readAsText("List_Pokemon2.json");
	...
	var jqxhr = JSON.parse(x);

	/*==== Set variables 1/2 ====*/
	var Pokemon_Name_CP = "Bulbasaur";//(document.getElementById("Pokemon_Name_CP").value);
